...
const CounterArea = () => {
  return (
    <section style={{ backgroundImage: `url(${bgImg})`, }} className='h-[400px] bg-cover bg-center relative'>
      <div className='bg-[#4f918a]/50 w-full h-full'>
        <div className='grid md:grid-cols-4 grid-cols-2 my-8 h-full container mx-auto items-center'>
          <div className='group'>
